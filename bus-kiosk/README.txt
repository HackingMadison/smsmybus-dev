...
You can see the kiosk in action here - http://www.smsmybus.com/motherfools/
...
index.html :: Primary HTML that displays the API data
 ...
 @todo add your own API key to the JavaScript calls in the header. you can get one by emailing api@smsmybus.com
 @todo you'll probably want to update the artwork in the header

kiosk.css :: Styling sheet

kiosk.js :: Self-contained JavaScript code that fetches the data from the API
